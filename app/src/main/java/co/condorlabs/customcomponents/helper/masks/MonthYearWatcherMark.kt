    ...
    override fun onTextChanged(newText: CharSequence?, start: Int, before: Int, count: Int) {
        ...
        if (!newText.isNullOrBlank() && newText.toString() != currentDate) {
            ...
            if (digitsFromDateTyped.length < MONTH_YEAR_MASK_LENGTH) {
                ...
                year = when {
                    year < DATEPICKER_MIN_YEAR -> DATEPICKER_MIN_YEAR
                    year > DATEPICKER_MAX_YEAR -> DATEPICKER_MAX_YEAR
                    else -> year
                }
                ...
                calendar.set(Calendar.DAY_OF_MONTH, DATEPICKER_FIRST_DAY_OF_MONTH)
