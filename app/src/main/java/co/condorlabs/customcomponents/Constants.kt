...
const val DEFAULT_COLLAPSIBLE_MARGIN = 8
const val COLLAPSIBLE_LINE_SEPARATOR_START_MARGIN = 30
const val COLLAPSIBLE_CARD_VIEW_START_MARGIN = -4
const val COLLAPSIBLE_CARD_VIEW_END_MARGIN = -4
const val COLLAPSIBLE_INDICATOR_ROTATION = 180F
const val COLLAPSIBLE_CARD_VIEW_TOP_MARGIN = 2
const val COLLAPSIBLE_PADDING_START = 16
const val COLLAPSIBLE_PADDING_END = 16
const val COLLAPSIBLE_TAG_MARGIN = 16
