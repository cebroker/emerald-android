...
const val EMPTY = ""
const val PHONE_FIELD_MAX_LENGTH = 14
const val PHONE_DIGITS = "0123456789-() "
...
const val PHONE_NUMBER_REGEX = "\\(\\d{3}\\)\\s\\d{3}-\\d{4}"
const val DEFAULT_PHONE_MASK = "(###) ###-####"
const val NO_DIGITS_REGEX = "[^\\d.]|\\."
const val DATE_REGEX = "\\d{2}\\/\\d{2}\\/\\d{4}"
const val SLASH = "/"
const val ZERO = 0
const val ONE = 1
const val PHONE_STRING_NON_DIGITS = "()- "
const val CHAR_TO_DESCRIBE_A_NUMBER = '#'
