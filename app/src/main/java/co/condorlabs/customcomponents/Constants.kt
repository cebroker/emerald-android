...
const val DEFAULT_COLLAPSIBLE_PADDING = 16
const val DEFAULT_COLLAPSIBLE_MARGIN = 16
...
const val LINE_SEPARATOR_HEIGHT = 2
const val DEFAULT_ICON_WIDTH = 100
const val DEFAULT_ICON_HEIGHT = 100
const val COLLAPSIBLE_PADDING_START = 60
const val COLLAPSIBLE_PADDING_END = 60
